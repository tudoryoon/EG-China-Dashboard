...
- For 6082.HK and 0100.HK only, enable the original trend engine's available-history provisional mode with at least 60 sessions while fewer than 200 observations exist. Display the existing provisional score-basis field; return to standard mode at 200 observations. 3109.HK uses the standard score after verified source history repairs, not provisional scoring.
